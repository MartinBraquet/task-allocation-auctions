...
for j = 1:M
        ...
        U_new = CalcUtility([agent.x, agent.y], agent.v_a, task_pos, task_tf, task_value, b_new, agent_idx, CBBA_Params.prob_a_t, CBBA_Params.N, winners_matrix, CBBA_Params.lambda);
