...
function [X, completed_tasks, J, J_to_completion_target] = OptimalControlSolution(pos_a, v_a, pos_t, v_t, radius_t, p_GCAA, Agents, tf_t, tloiter_t, time_step, n_rounds, na, kdrag)
    ...
    for i = 1:na
        ...
        if k == 1 && sum(completed_tasks == p_GCAA{i}) == 0
